...
- Why you should learn react ⬇️ 

- A bit about React's philosophy ⬇️ 
...
<iframe height="260" width="1000" src="https://docs.google.com/document/d/1nPeQ0bahVgfDKag2QB9ztRsIRs0NDAqJ9tCkeBt2iI8/edit"></iframe>
...
Again, details of this are not important to remember, but you do want to remember that JSX requires transpilation via babel in order to run in the browser. If you're using the create-react-app generator, then all of this is already configured for you up front, including a live updating development server!
</Notes>
